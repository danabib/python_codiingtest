...
SIZE = 15
# ★★★★★ 핵심 수정 2: 탐색 시간 증가 및 애니메이션 속도 조절 ★★★★★
MAX_STEPS = 1000      # 탐색 스텝 증가 (300 -> 1000)
ANIMATION_DELAY = 10  # 애니메이션 지연시간 감소 (50ms -> 10ms)
...
class PathfindingGUI:
    ...
    def load_model(self):
        try:
            ...
            return model
        except FileNotFoundError: messagebox.showerror("오류", "'dqn_model.pt' 파일을 찾을 수 없습니다."); return None
